...
class DynamicOllamaInput:
    ...
    def input_model(self):
        ...
        if model_input in model_name:
            ...
            print(
                "This model is not available in our system, we will use 'qwen' by default"
            )
            self.model = "qwen"
        ...
        print(
            "Give the sytem prompt if you want to give write 'yes' to add prompt and 'no' to not add"
        )
